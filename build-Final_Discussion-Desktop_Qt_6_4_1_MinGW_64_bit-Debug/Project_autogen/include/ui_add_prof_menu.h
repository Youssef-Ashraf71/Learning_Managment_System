...
public:
    ...
    void setupUi(QDialog *add_prof_menu)
    {
        ...
        add_prof_menu->resize(574, 504);
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(add_prof_menu->sizePolicy().hasHeightForWidth());
        add_prof_menu->setSizePolicy(sizePolicy);
        add_prof_menu->setMinimumSize(QSize(1, 1));
