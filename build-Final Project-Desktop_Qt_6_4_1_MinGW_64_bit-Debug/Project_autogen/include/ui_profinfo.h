...
public:
    ...
    void setupUi(QMainWindow *profinfo)
    {
        ...
        assignbtn = new QPushButton(widget_4);
        assignbtn->setObjectName("assignbtn");
        assignbtn->setGeometry(QRect(220, 50, 150, 29));
        assignbtn->setMaximumSize(QSize(150, 16777215));
        courses_combo = new QComboBox(widget_4);
        courses_combo->setObjectName("courses_combo");
        courses_combo->setGeometry(QRect(10, 50, 180, 30));
        ...
        courses_combo->setMaximumSize(QSize(180, 30));
